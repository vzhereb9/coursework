...
int main() {
    ...
    printf("Average classic calc speed for 4,8,..,64 drives is %.2f KB/s\n", final_avg_speed_calc_classic);
    printf("Average classic recover speed for 4,8,..,64 drives is %.2f KB/s\n", final_avg_speed_recover_classic);
    ...
    printf("Average vector calc speed for 4,8,..,64 drives is %.2f KB/s\n", final_avg_speed_calc_vector);
    printf("Average vector recover speed for 4,8,..,64 drives is %.2f KB/s\n", final_avg_speed_recover_vector);
    return 0;
}